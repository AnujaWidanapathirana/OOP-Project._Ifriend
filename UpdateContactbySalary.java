...
public class UpdateContactbySalary extends JFrame {
    private int index;
    ...
    private void  makingUI(){
        ...
        titleLabel=new JLabel("<Update Salary>");
    ...
    private void setupListeners(){
        ...
        cancel.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent evt) {
				normalize();
                UpdateContactbySalary.this.dispose();
            }
        });
		update.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent evt){
				...
				if(!ContactController.isValidSalary(sal)){
					checkSalary();
					}
				if(ContactController.isValidSalary(sal)){
					ContactController.updateSalary(sal,index);
					normalize();
					popup();
				}
				}
