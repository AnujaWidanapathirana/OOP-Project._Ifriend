...
public class UpdateContactbyPhoneNumber extends JFrame {
    private int index;
    ...
    public UpdateContactbyPhoneNumber() {
        makingUI();
        setupListeners();
    ...
    private void  makingUI(){
        ...
        titleLabel=new JLabel("<Update Phone Number>");
        ...
        lblNew=new JLabel("            New Phone Number");
        lblNew.setFont(new Font("",Font.PLAIN,20));
    ...
    private void setupListeners(){
        ...
        cancel.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent evt){
				normalize();
                UpdateContactbyPhoneNumber.this.dispose();
            }
        });
		update.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent evt){
				String str=newName.getText();
				if(!ContactController.isValidPhoneNumber(str)){
					checkphone();
				}
				if(ContactController.isValidPhoneNumber(str)){
				ContactController.updatePhonenumber(str,index);
				normalize();
				popup();
				}
			}		
